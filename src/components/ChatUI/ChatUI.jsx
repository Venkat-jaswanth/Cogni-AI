...
const ChatUI = () => {
   ...
   return (
      <div className={`chat-container ${messages.length > 0 ? 'has-messages' : ''}`}>
         ...
         <div className="chat-messages">
            {messages.length === 0 ? (
               <div className={`welcome-screen ${isTyping ? 'typing' : ''}`}>
                  ...
                  <div className={`welcome-examples ${isTyping ? 'typing' : ''}`}>
         ...
         {/* Input Area */}
         <div className={`chat-input-container ${showCenteredInput ? 'centered' : ''} ${messages.length > 0 ? 'has-messages' : ''}`}>
            <div className={`chat-input-wrapper ${showCenteredInput ? 'centered' : ''} ${messages.length > 0 ? 'has-messages' : ''}`}>
               <div className={`chat-input-area ${showCenteredInput ? 'centered' : ''} ${messages.length > 0 ? 'has-messages' : ''}`}>
                  <textarea
                     value={input}
